...
writeRaster(soy_stack, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_daily_soy.nc", format="CDF", overwrite=T)
writeRaster(wheat_stack, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_daily_wheat.nc", format="CDF", overwrite=T)
writeRaster(maize_stack, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_daily_maize.nc", format="CDF", overwrite=T)
writeRaster(ag_stack, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_daily_agriculture.nc", format="CDF",overwrite=T)

#####################################################################################################################################
# CATEGORICAL SPATIAL MASK
#####################################################################################################################################

soy <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_daily_soy.nc")
wheat <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_daily_wheat.nc")
maize <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_daily_maize.nc")
ag <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_daily_agriculture.nc")
...
#write out
writeRaster(wheat, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/NLDAS_daily_wheat.nc", format="CDF", overwrite=T)
writeRaster(soy, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/NLDAS_daily_soy.nc", format="CDF", overwrite=T)
writeRaster(maize, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/NLDAS_daily_maize.nc", format="CDF", overwrite=T)
...
writeRaster(lulc_bin_mask, "/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_daily_ecological.nc", format="CDF",overwrite=T)
...
writeRaster(ag, "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/NLDAS_daily_agriculture.nc", format="CDF", overwrite=T)
writeRaster(eco, "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/NLDAS_daily_ecological.nc", format="CDF", overwrite=T)
...
maize <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_daily_maize.nc")
ag <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_daily_agriculture.nc")
eco <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_daily_ecological.nc") #where == 1
...
writeRaster(wheat, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/NLDAS_365_wheat_frac.nc", format="CDF",overwrite=T)
...
writeRaster(soy, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/NLDAS_365_soy_frac.nc", format="CDF",overwrite=T)
...
writeRaster(maize, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/NLDAS_365_maize_frac.nc", format="CDF",overwrite=T)
...
writeRaster(ag, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/NLDAS_365_ag_frac.nc", format="CDF",overwrite=T)
...
writeRaster(eco, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/NLDAS_365_eco_frac.nc", format="CDF",overwrite=T)
