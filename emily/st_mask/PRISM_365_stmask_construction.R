...
# writeRaster(maize_stack, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/PRISM_365_maize.nc", format="CDF", overwrite=T)
# writeRaster(ag_stack, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/PRISM_365_agriculture.nc", format="CDF",overwrite=T)
...
# 
# #ag/eco flag
# lulc_bin <- raster("/nfs/datadrivendroughteffect-data/Data/Masks/lulc_mode/PRISM_lulc_bin.nc") #eco == 1, agro == 2
...
# eco[eco != 1] <- NA
# 
# writeRaster(wheat, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/PRISM_365_wheat.nc", format="CDF", overwrite=T)
# writeRaster(soy, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/PRISM_365_soy.nc", format="CDF", overwrite=T)
# writeRaster(maize, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/PRISM_365_maize.nc", format="CDF", overwrite=T)
# writeRaster(ag, "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/PRISM_365_ag.nc", format="CDF", overwrite=T)
# writeRaster(eco, "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/PRISM_365_eco.nc", format="CDF", overwrite=T)
...
maize <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/PRISM_365_maize.nc")
ag <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/PRISM_365_agriculture.nc")
#eco <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/PRISM_365_ecological.nc") #where == 1
...
writeRaster(wheat, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/PRISM_365_wheat_frac.nc", format="CDF",overwrite=T)
...
writeRaster(soy, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/PRISM_365_soy_frac.nc", format="CDF",overwrite=T)
...
writeRaster(maize, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/PRISM_365_maize_frac.nc", format="CDF",overwrite=T)

#test <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/PRISM_365_maize_frac.nc")
