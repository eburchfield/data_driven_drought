...
n <- 26 #time step within year
doy <- seq(from = 1, to = 364, by = 14)
...
# 
# writeRaster(soy_stack, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_weekly_soy.nc", format="CDF", overwrite=T)
# writeRaster(wheat_stack, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_weekly_wheat.nc", format="CDF", overwrite=T)
# writeRaster(maize_stack, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_weekly_maize.nc", format="CDF", overwrite=T)
# writeRaster(ag_stack, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_weekly_agriculture.nc", format="CDF",overwrite=T)

#####################################################################################################################################
# CATEGORICAL SPATIAL MASK
#####################################################################################################################################

soy <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_weekly_soy.nc")
wheat <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_weekly_wheat.nc")
maize <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_weekly_maize.nc")
ag <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_weekly_agriculture.nc")
...
#write out
writeRaster(wheat, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/NLDAS_26_wheat.nc", format="CDF", overwrite=T)
writeRaster(soy, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/NLDAS_26_soy.nc", format="CDF", overwrite=T)
writeRaster(maize, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/NLDAS_26_maize.nc", format="CDF", overwrite=T)
...
writeRaster(lulc_bin_mask, "/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_weekly_ecological.nc")
...
writeRaster(ag, "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/NLDAS_26_agriculture.nc", format="CDF", overwrite=T)
writeRaster(eco, "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/NLDAS_26_ecological.nc", format="CDF", overwrite=T)
...
maize <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_weekly_maize.nc")
ag <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_weekly_agriculture.nc")
eco <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/NLDAS_weekly_ecological.nc") #where == 1
...
writeRaster(wheat, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/NLDAS_weekly_wheat_frac.nc", format="CDF",overwrite=T)
...
writeRaster(soy, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/NLDAS_weekly_soy_frac.nc", format="CDF",overwrite=T)
...
writeRaster(maize, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/NLDAS_weekly_maize_frac.nc", format="CDF",overwrite=T)
...
writeRaster(ag, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/NLDAS_weekly_ag_frac.nc", format="CDF",overwrite=T)
...
writeRaster(eco, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/NLDAS_weekly_eco_frac.nc", format="CDF",overwrite=T)
