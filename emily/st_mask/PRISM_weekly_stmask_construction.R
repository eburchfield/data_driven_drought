...
n <- 52 #time step within year
doy <- seq(from = 1, to = 364, by = 7)
...
# 
# writeRaster(soy_stack, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/PRISM_weekly_soy.nc", format="CDF", overwrite=T)
# writeRaster(wheat_stack, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/PRISM_weekly_wheat.nc", format="CDF", overwrite=T)
# writeRaster(maize_stack, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/PRISM_weekly_maize.nc", format="CDF", overwrite=T)
# writeRaster(ag_stack, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/PRISM_weekly_agriculture.nc", format="CDF",overwrite=T)

#####################################################################################################################################
# SPATIAL MASK
#####################################################################################################################################

# soy <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/PRISM_365_soy.nc")
# wheat <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/PRISM_365_wheat.nc")
# maize <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/PRISM_365_maize.nc")
# ag <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/PRISM_365_agriculture.nc")
# 
# lulc <- raster("/nfs/datadrivendroughteffect-data/Data/Masks/we_run/PRISM_lulc_final.tif")
...
# 
# writeRaster(soy, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/PRISM_weekly_soy.nc", format="CDF", overwrite=T)
# writeRaster(wheat, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/PRISM_weekly_wheat.nc", format="CDF", overwrite=T)
# writeRaster(maize, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/PRISM_weekly_maize.nc", format="CDF", overwrite=T)
# 
# #ag/eco flag
# 
# lulc_bin <- raster("/nfs/datadrivendroughteffect-data/Data/Masks/lulc_mode/PRISM_lulc_bin.nc")
...
# eco[eco != 1] <- NA
# 
# writeRaster(ag, "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/PRISM_weekly_agriculture.nc", format="CDF", overwrite=T)
# writeRaster(eco, "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/PRISM_weekly_ecological.nc", format="CDF", overwrite=T)
...
#open time masks
wheat <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/PRISM_weekly_wheat.nc")
soy <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/PRISM_weekly_soy.nc")
maize <- brick("/nfs/datadrivendroughteffect-data/Data/Masks/time_masks/PRISM_weekly_maize.nc")
...
#ag_lulc <- raster("/nfs/datadrivendroughteffect-data/Data/Masks/lulc_frac/ag_prism.nc")
#eco_lulc <- raster("/nfs/datadrivendroughteffect-data/Data/Masks/lulc_frac/eco_prism.nc")
...
writeRaster(wheat, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/PRISM_weekly_wheat_frac.nc", format="CDF",overwrite=T)
...
writeRaster(soy, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/PRISM_weekly_soy_frac.nc", format="CDF",overwrite=T)
...
writeRaster(maize, filename = "/nfs/datadrivendroughteffect-data/Data/Masks/final_masks/PRISM_weekly_maize_frac.nc", format="CDF",overwrite=T)
