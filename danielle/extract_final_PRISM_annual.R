...
data_brick <- paste("/nfs/datadrivendroughteffect-data/Data/PRISM/Masked/annual/PRISM_annual_",var.name,"_", 
                          crop, "_",year.start,"-",year.end,".nc", sep="")
...
fn <- paste('/nfs/datadrivendroughteffect-data/Data/Final_panels/PRISM_annual_',var.name,'_', crop, '.rds', sep='')
