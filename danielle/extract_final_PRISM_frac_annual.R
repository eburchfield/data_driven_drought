...
data_brick <- paste("/nfs/datadrivendroughteffect-data/Data/PRISM/Masked/annual/PRISM_annual_ppt_", 
                          crop, "_frac_1981-2015.nc", sep="")
...
fn <- paste('/nfs/datadrivendroughteffect-data/Data/Final_panels/PRISM_annual_ppt_frac_', crop, '.rds', sep='')
